...
export const asyncRoute = [
  ...
  },
  {
    ...
    children: [
      {
        path: "/app/userSystem/tenantInfo",
        component: loadable(() => import("../pages/userSystem/tenantInfo/index")),
        meta: { title: "租户管理" },
        exact: true,
      },
      {
      ...
      {
        path: "/app/userSystem/regionInfo",
        component: loadable(() => import("../pages/userSystem/regionInfo/index")),
        meta: { title: "区域管理" },
        exact: true,
      },
    ],
